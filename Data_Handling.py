...
os.chdir(r"C:\Users\kutlw\.spyder-py3\DataHandling")
#%%
# Import the data
...
#.loc and .query will give you same result, if you want to use .query:

#racing_oval = racing.query("Track == 'OvalTrack'")
#racing_oval_straight = racing.query("Track in ['StraightTrack', 'OvalTrack']")
#racing_oval_bayes = racing.query("Track == 'OvalTrack' and Engine == 'Bayes'")
...
# Remove the last 10 observations/Rows
